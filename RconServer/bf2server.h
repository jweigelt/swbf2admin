...
#if not-defined(GALAXY) && defined(EXPERIMENTAL_UPS)
#error Experimental features are only available for the galaxy version
#endif
...
#define OFFSET_NORENDER_FIX 0x006BB37F - 0x400000 - 0x1090
#define OFFSET_VOTECRASH_FIX 0x005D2282 - 0x400000 - 0xF80
#define OFFSET_VOTEKICK_FIX 0x00599B11 - 0x400000 - 0xFB0

#define OFFSET_PASSWORD_FIX 0x00599BC5 - 0x400000 - 0xFB0
#define OFFSET_PASSWORD_PLAIN 0x01E31C40 - 0x400000 - 0x14A0

#define OFFSET_NUMPLAYERS_MOD 0x005D7F31 - 0x400000 - 0x10B0
#define OFFSET_DEDICATED_FIX  0x005D800F - 0x400000 - 0x10B0

#define OFFSET_MAPFIX_DETOUR 0x005B6076 - 0x400000 - 0xFB0
#define OFFSET_MAPFIX_RETN 0x005B607D- 0x400000 - 0xFB0
#define OFFSET_MAP_STATUS 0x01EB1054 - 0x00400000 - 0x13B4
...
#define OFFSET_GAMEPORT 0x007E8EF4 - 0x400000
#define OFFSET_IDLE 0x01E58EBD - 0x400000 - 0x14B0

#define OFFSET_SPAWNVALUE_MOD_FLOAT 0x0058D605 - 0x400000 + 4 - 0xFB0

#define OFFSET_LUA_STATE 0x01E58E50 - 0x400000 - 0x14B0
#define OFFSET_LUA_LOAD_BUFFER 0x0069C0C0 - 0x400000 - 0x1090
#define OFFSET_LUA_PCALL 0x0069CF40- 0x400000- 0x1090
